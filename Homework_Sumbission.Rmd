...
It is apparent from the mixture of styles (e.g. camelCase) and abundance of error causing characters (especially spaces and misformatted symbols) that we should clean our dataset. Here, it is important to resist the urge to edit the raw data, as this ruins reproducibility. Instead we should make a new dataset.
...
The above code begins by sourcing a file named "cleaning.r" from within our directory. It uses code written by Dr Lydia France
